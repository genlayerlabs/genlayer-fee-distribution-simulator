...
def main():
    ...
    print("3. Round 2: Second validator appeal - successful (against the first appeal)")
    print("4. Round 3: Final normal round where majority agreed (after successful appeal)")
    print("5. Results:")
    print("   - Round 0 becomes SKIP_ROUND (due to successful appeal)")
    ...
    print("6. The appeal bond from Round 1 is split among participants in Round 3")
    print("7. This demonstrates how consecutive appeals and their resolution work")

#!/usr/bin/env python3
"""
Validator Appeal Example

This example demonstrates a transaction with a successful validator appeal.
The validators successfully appeal against the majority decision.
"""
...
def main():
    print("\n" + "=" * 80)
    print(" VALIDATOR APPEAL EXAMPLE ")
    print("=" * 80)
    print("\nScenario: Validators successfully appeal the majority decision, followed by a new round")
    print(
        "Path: START → LEADER_RECEIPT_MAJORITY_AGREE → VALIDATOR_APPEAL_SUCCESSFUL"
    )
    print("      → LEADER_RECEIPT_MAJORITY_DISAGREE → END")
    print("-" * 80)
    ...
    # Define the transaction path with a successful validator appeal
    path = [
        "START",
    ...
    print("2. Round 1: Validators appealed and were successful")
    print("3. Round 2: New normal round where majority disagreed (after successful appeal)")
    print("4. Result: The first round (Round 0) is marked as SKIP_ROUND")
    print("5. Appealant earns the appeal bond")
    print("6. Original majority validators from Round 0 are penalized")
    print("7. Round 2 processes normally with the disagreement outcome")

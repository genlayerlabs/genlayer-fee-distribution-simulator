...
# principal (1.0) plus profit (APPEAL_REWARD_MULTIPLE - 1.0). The on-chain
# contract encodes this as `(appealBond * 3) / 2` in FeesProcessor.sol; keep
# this value in lockstep with that constant.
APPEAL_REWARD_MULTIPLE = 1.5
